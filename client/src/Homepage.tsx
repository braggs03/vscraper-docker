    ...
    return (
        <>
            ...
            <main className="flex flex-col items-center justify-center text-center min-h-screen">
                ...
                <h1 className="m-5 font-sans text-3xl">
                    A Simple Tool for Youtube DL's Weak Spots.
                </h1>
                <div className="flex flex-row">
                    <Button className="mr-1">
                        <a
                            href="https://github.com/braggs03/vscraper"
                            target="_blank"
                        >
                            About
                        </a>
                ...
                <div className="flex items-center gap-3 mt-3">
                    <Checkbox
                        id="homepage_preference"
                        checked={preference}
                        onClick={() => setPreference(!preference)}
                    />
                    <Label htmlFor="homepage_preference">
                        Don't Show on Start
                    </Label>
                </div>
            </main>
